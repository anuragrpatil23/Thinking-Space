...
- macOS (Apple Silicon): [Thinking Space 2.9.5 arm64 DMG](https://github.com/anuragrpatil23/Thinking-Space/releases/download/v2.9.5/Thinking.Space-2.9.5-arm64.dmg)
- Windows (x64): [Thinking Space 2.9.5 x64 Setup](https://github.com/anuragrpatil23/Thinking-Space/releases/download/v2.9.5/Thinking.Space.Setup.2.9.5-x64.exe)
