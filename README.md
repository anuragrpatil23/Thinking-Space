...
- macOS (Apple Silicon): [Thinking Space 2.9.6 arm64 DMG](https://github.com/anuragrpatil23/Thinking-Space/releases/download/v2.9.6/Thinking.Space-2.9.6-arm64.dmg)
- macOS (Intel): [Thinking Space 2.9.6 x64 DMG](https://github.com/anuragrpatil23/Thinking-Space/releases/download/v2.9.6/Thinking.Space-2.9.6-x64.dmg)
- Windows (x64): [Thinking Space 2.9.6 x64 Setup](https://github.com/anuragrpatil23/Thinking-Space/releases/download/v2.9.6/Thinking.Space.Setup.2.9.6-x64.exe)
