...
export default function AiActivityRestDaysSettingsBlock() {
  ...
  return (
    <SettingsGroupBlock
      heading="Claude Code reset day"
      footnote="All instances of that weekday in the current month get a soft marker on AI-Activity views so you can pace against the next reset. Past months stay unchanged."
    >
      <SettingsRowBlock
        label="Weekly quota resets on"
        control={(
