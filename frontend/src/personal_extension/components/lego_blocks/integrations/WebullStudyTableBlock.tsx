            ...
            >
              ...
              {impNote && !isExpanded && (
                <div
                  ...
                  title={impNote.raw}
                >
                  <span className={cn('mt-px shrink-0 rounded px-1.5 py-0.5 text-[9px] font-semibold uppercase tracking-wide', chipColorClassBlock('amber'))}>
                    Imp
                  </span>
                  ...
                  {row.record.impQuickNotes.length > 0 && (
                    <div className="mb-4">
                      <div className="mb-2 flex items-center gap-1.5 text-[10px] font-semibold uppercase tracking-wide text-amber-700 dark:text-amber-300">
                        <span className={cn('rounded px-1.5 py-0.5 text-[9px]', chipColorClassBlock('amber'))}>
                          Imp
                        </span>
                        Quick note
                      </div>
