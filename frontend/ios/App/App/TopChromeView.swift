...
/// subtrees report 0 insets, so the phone shell's status-bar scrim resolves
/// the real inset from the window instead.
func resolvedKeyWindowSafeAreaTopInset() -> CGFloat {
